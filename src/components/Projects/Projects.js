      ...
      <div className={styles.container}>
        <AnimateOnScroll>
          <SectionHeading
            ...
            subtitle="Practical machine learning models, analytics dashboards, and AI solutions built through coursework, projects, and research"
          />
        </AnimateOnScroll>
                ...
                <div className={styles.cardContent}>
                  ...
                  <div className={styles.cardLinks}>
                    ...
                    {(project.links?.demo || project.demo) && (
                      <a
                        href={project.links?.demo || project.demo}
                        target="_blank"
                        rel="noopener noreferrer"
